...
export const metadata: Metadata = {
  title: "DeckMaster - Hearthstone Deck Builder & Meta Tracker",
  description: "Build legendary Hearthstone decks with our advanced deck builder, card database, and meta analysis tools. Join 250K+ players climbing the ladder.",
  keywords: "hearthstone, deck builder, card game, meta tracker, tournament decks",
  metadataBase: new URL("https://deckmaster.com"),
  alternates: {
    canonical: "https://deckmaster.com"
  },
  openGraph: {
    title: "DeckMaster - Build Legendary Hearthstone Decks",
    description: "Master the meta with our advanced deck builder and tournament-winning strategies",
    url: "https://deckmaster.com",
    siteName: "DeckMaster",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35IBXHDuVlkcBNeD17jI0bcqZ1z/uploaded-1763394158908-8hs0l2fs.jpg",
        alt: "DeckMaster Hearthstone deck builder"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "DeckMaster - Build Legendary Hearthstone Decks",
    description: "Master the meta with our advanced deck builder and tournament-winning strategies",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35IBXHDuVlkcBNeD17jI0bcqZ1z/uploaded-1763394158908-8hs0l2fs.jpg"]
  },
  robots: {
    index: true,
    follow: true
